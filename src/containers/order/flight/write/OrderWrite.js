...
class OrderWrite extends Component {
  ...
  renderPassenger() {
    return (
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: "#ffffff", marginTop: 8 }}>
        ...
        <TouchableOpacity style={{ marginTop: 8, marginBottom: 8, marginRight: 10, borderRadius: 10, backgroundColor: "#51a6f0" }} activeOpacity={0.6}>
  ...
  renderDeliveries() {
    return (
      <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "#ffffff", marginTop: 8 }} activeOpacity={0.6}>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginLeft: 10 }}>配送方式</Text>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginRight: 10 }}>不需要配送</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderPayment() {
    return (
      <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "#ffffff", marginTop: 8 }} activeOpacity={0.6}>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginLeft: 10 }}>支付方式</Text>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginRight: 10 }}>企业垫付</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderCostCenter() {
    return (
      <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "#ffffff", marginTop: 8 }} activeOpacity={0.6}>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginLeft: 10 }}>成本中心</Text>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginRight: 10 }}>默认成本中心</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderIntegral() {
    return (
      <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', backgroundColor: "#ffffff", marginTop: 8 }} activeOpacity={0.6}>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginLeft: 10 }}>常旅客卡积分</Text>
        <Text style={{ fontSize: 14, color: "#323b43", marginTop: 15, marginBottom: 15, marginRight: 10 }}>不累计</Text>
      </TouchableOpacity>
    );
  }
  ...
  renderExtraInfo() {
    return (
      <View style={{ alignItems: 'center', margin: 10 }}>
        <Text>飞巴商旅</Text>
        <Text style={{ color: '#74b8f3', fontSize: 12, marginTop: 10, textDecorationLine: 'underline' }}> 致电质询</Text>
